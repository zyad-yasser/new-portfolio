  ...
  const defaultItems = [
    {
      ...
      text: "With high skills, and modern stack, we can deliver the best premium quality you need for your project.",
    },
    {
      icon: "chrome",
      title: "Cross browsers",
      text: "You get a products that run perfectly for the set of browsers you select, to insure the best availability.",
    },
    {
      icon: "code-alt",
      title: "Optimized code",
      text: "Optimized, and clean code, ready to be reused, easily maintained, or have new relases upon it.",
    },
    {
      icon: "paint-bucket",
      title: "Perfect designs",
      text: "Whatever how complex the design we can do it, or we can design high precision and modern designs.",
    },
  ];
  ...
  return (
    ...
    >
      <div className={`d-flex align-items-center w-100 ${styles.miniSlider}`}>
        ...
        <div
          className={`d-flex align-items-center position-relative h-100 mi-sl-c-c ${styles.items}`}
        >
          <div
          ...
          >
            {items.map((item, index) => {
              return (
                <div
                  key={index}
                  className="d-flex align-items-start mi-sl-c col"
                ...
                >
                  ...
                  <div className="right ml-2 flex-grow-1">
                    <div
                      className={`w-100 ${styles.title} ${itemsPerPage === 1 ? "text-center" : ""}`}
                    >
                      {item.title}
                    </div>
                    <div
                      className={`w-100 mt-1 ${styles.text} ${itemsPerPage === 1 ? "text-center" : ""}`}
                    >
                      {item.text}
                    </div>
                  </div>
