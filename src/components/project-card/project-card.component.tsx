...
const ProjectCard = ({ project, type }: ProjectCardProps) => {
  ...
  return (
    <div
      className={`my-5 d-flex justify-content-center align-items-center ${styles.oneProject} ${type === "left" ? "flex-row" : "flex-row-reverse"}`}
    >
      <div
        className={`d-flex flex-column justify-content-center align-items-center ${styles.text}`}
      >
        <div
          className={`d-flex justify-content-center align-items-center mb-3 w-75 ${styles.description}`}
        >
          {description}
        </div>
        ...
        {link && (
          <div className={`d-flex justify-content-center align-items-center mt-4 ${styles.link}`}>
