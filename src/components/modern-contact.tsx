                  ...
                  <form className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="name" type="text" placeholder="Your name" className="h-12" />
                      </div>
                      <div>
                    ...
                    <Button size="lg" className="w-full text-lg py-6 btn-glow">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              {contactInfo.map((info, index) => (
                <Card key={index} className="p-6 card-hover bg-card border border-border">
