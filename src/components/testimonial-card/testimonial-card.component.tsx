...
const TestimonialCard = ({ data }: { data: Testimonial }) => {
  return (
    <div className={`d-flex flex-column w-100 ${styles.card}`}>
      <div
        className={`d-flex align-items-center justify-content-center w-100 position-relative ${styles.content}`}
      >
        <div className={`d-flex align-items-start justify-content-center ${styles.begin}`}>
          <i className="lni-quotation" />
        </div>
        <div className={`d-flex align-items-center justify-content-center w-100 ${styles.body}`}>
          {data.body}
        </div>
        <div className={`d-flex align-items-end justify-content-center ${styles.end}`}>
          <i className="lni-quotation" />
        </div>
      </div>
      <div
